...
export const availableToolSlugs=['theory-of-change','ethical-bridge-crm','issue-risk-management','people-check-ins-development','strategy-kpis-annual-planning','gantt'];
export const invitationToolSlugs=['theory-of-change','ethical-bridge-crm'];
export const previewToolSlugs=['issue-risk-management','people-check-ins-development','strategy-kpis-annual-planning','gantt'];
const launchUrls={
