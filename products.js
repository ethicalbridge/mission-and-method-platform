...
export const availableToolSlugs=['theory-of-change','ethical-bridge-crm'];
const launchUrls={
 'theory-of-change':'http://localhost:8765/Theory-of-Change-Builder.html?v=tooltip-excel',
...
export const softwareProducts=[
 ...
 ['gantt','Gantt Tool','Project management','Project leads planning a timeline','Put tasks on a calendar and discuss sequencing and overlap.',['Task','Owner','Start','Finish','Dependency']],
...
].map(([slug,name,category,audience,description,fields])=>({id:`software_${slug.replaceAll('-','_')}`,slug,name,category,audience,description,fields,launchUrl:launchUrls[slug]||null,kind:'software',suiteIncluded:pricing.suite.toolSlugs.includes(slug),billing:['monthly','annual'],prices:{monthly:null,annual:null},currency:pricing.currency,status:availableToolSlugs.includes(slug)?'available':'coming_soon',trial:null,checkout:{monthly:null,annual:null},dataNamespace:`mm.software.${slug}.v1`,entitlements:[]}));
