...
test('the guest code grants browser access only to the completed tools',()=>{
 ...
 assert.deepEqual(availableToolSlugs,['theory-of-change','ethical-bridge-crm','issue-risk-management','people-check-ins-development','strategy-kpis-annual-planning','gantt']);
